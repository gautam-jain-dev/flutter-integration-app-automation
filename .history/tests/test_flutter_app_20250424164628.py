...
parser.add_argument("--os", type=str, required=True help="OS type (iOS or Android)")
...
elif args.os.lower() == "ios":
    options.load_capabilities(CAPS_IOS)
else:
    raise ValueError("Invalid OS type. Please use 'iOS' or 'Android'.")
